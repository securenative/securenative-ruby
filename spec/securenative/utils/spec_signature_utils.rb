...
RSpec.describe SecureNative::Utils::SignatureUtils do
  it 'verifies request payload' do
    ...
    expect(SecureNative::Utils::SignatureUtils.valid_signature?(secret_key, payload, signature)).to be_truthy
  end

  it 'verifies request empty signature' do
    expect(SecureNative::Utils::SignatureUtils.valid_signature?('', '', 'B00C42DAD33EAC6F6572DA756EA4915349C0A4F6')).to be_falsey
  end
end
